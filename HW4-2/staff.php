...
<body>
    <div class="container">
        ...
        <form action="#" method="post">
            <input type="text" name="kw" placeholder="Enter here" value="">
            <input type="submit">
        </form>
        <H1><a href='newstaff.php'><span class='glyphicon glyphicon-plus'></span></a>&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;<button type="button" class="btn btn-warning" onclick="history.back();">Back</button></H1>
        <?php
        ...
        if ($result->num_rows == 0) {
            ...
            $table = "<table class='table table-hover'>
                        <thead>
                            <tr>
                                ...
                                <th scope='col'><div align=center>หน้าจัดการข้อมูลบุคลากร</div></th>
                            </tr>
                        </thead>
                        <tbody>";
            ...
            while($row = $result->fetch_object()){ 
                ...
                $table.= "<td>";
                $table.= "<div align=center><a href='editstaff.php?id=$row->id'><span class='glyphicon glyphicon-pencil' aria-hidden='true'></span></a>";
                $table.= " | ";
                $table.= "<a href='deletestaff.php?id=$row->id'><span class='glyphicon glyphicon-trash' aria-hidden='true'></span></a></div>";
                $table.= "</td>";
                $table.= "</tr>";
            }
